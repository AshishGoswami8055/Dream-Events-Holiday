      ...
      <div className="container-custom">
        <FadeIn>
          <SectionHeading
            ...
            description="Every journey is designed with care, comfort, and attention to detail — so you can travel with confidence."
          />
        </FadeIn>
          ...
          {WHY_CHOOSE_US.map((item) => {
            ...
            return (
              <StaggerItem key={item.title}>
                <div className="h-full rounded-2xl bg-background p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1">
